...
export class LoginService {
  private urlEndPoint: string = "http://153.92.4.190:8080/surveygenerator/auth";
  ...
  sendAdminStatus(isAdmin: boolean) {
    return this.http.post('http://localhost:7000/api/admin-status', { isAdmin });
  }
}